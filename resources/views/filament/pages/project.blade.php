                        ...
                        <ul class="mt-3 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($this->project->files as $file)
                                <li class="py-3 flex justify-between items-center">
                                    ...
                                    <a href="{{ Storage::url($file->path) }}" target="_blank" class="inline-flex items-center px-2.5 py-1 text-xs font-medium rounded text-primary-700 bg-primary-50 hover:bg-primary-100 dark:text-primary-400 dark:bg-primary-900/50 dark:hover:bg-primary-900">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
